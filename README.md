# Celostar-Starrocks README.md
Celostar-Starrocks is the Celonis fork from Starrocks, which implements custom capabilities.
Documentation about the Celonis internal Celostar ecosystem is hosted on [Roadie](https://celonis.roadie.so/docs/default/component/celostar-wiki/). To contribute to the documentation open a PR in the [celostar-wiki](https://github.com/celonis/celostar-wiki).

--- 

# Upstream Starrocks README.md
