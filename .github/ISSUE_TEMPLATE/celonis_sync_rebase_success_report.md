---
title: Sync Rebase Success Report on {{ date | date('YYYY-MM-DD, hh:mm:ss z') }}
assignees: fieldsfarmer
labels: sync_rebase_success
---
...
The rebase branch is: {{ env.new_rebase_branch }}
...
[https://github.com/celonis/celostar-starrocks/pull/new/{{ env.new_rebase_branch }}](https://github.com/celonis/celostar-starrocks/pull/new/{{ env.new_rebase_branch }})
