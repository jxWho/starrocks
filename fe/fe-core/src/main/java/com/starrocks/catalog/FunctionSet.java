...
public class FunctionSet {
    ...
    public static final String CELONIS_EXPLORE_PROCESS = "celonis_explore_process";
    ...
    public static final String CELONIS_CALC_THROUGHPUT = "celonis_calc_throughput";
    ...
    public static final Set<String> celonisAlwaysReturnNonNullableFunctions =
            ImmutableSet.<String>builder()
                    ...
                    .add(FunctionSet.CELONIS_IN_JSON_ARRAY)
                    .build();
    ...
    private void initCelonisAggregateBuiltins() {
        ...
        cluster_variants_sf.add(new StructField("hash", Type.ARRAY_LARGEINT));
        ...
        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.CELONIS_MAKE_WORKDAY_CALENDAR,
                    Lists.newArrayList(Type.BIGINT, Type.VARCHAR, Type.VARCHAR), Type.ARRAY_VARCHAR, Type.ANY_STRUCT,
                    true, false, true));
        // celonis_inductive_miner
        ...
        // @paramType columns: [ ARRAY_VARCHAR, BIGINT, BIGINT, BOOLEAN ]
        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.CELONIS_EXPLORE_PROCESS,
                Lists.newArrayList(Type.ARRAY_VARCHAR, Type.BIGINT, Type.BIGINT, Type.BOOLEAN), Type.VARCHAR, Type.VARCHAR,
                false, false, false));
        // celonis_trimmed_mean
