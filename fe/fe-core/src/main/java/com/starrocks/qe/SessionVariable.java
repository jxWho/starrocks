...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_ARRAY_MAP_LOW_CARDINALITY_OPTIMIZE = "enable_array_map_low_cardinality_optimize";
    public static final String ENABLE_MULTI_IN_LOW_CARDINALITY_OPTIMIZE = "enable_multi_in_low_cardinality_optimize";
    ...
    @VariableMgr.VarAttr(name = ENABLE_ARRAY_MAP_LOW_CARDINALITY_OPTIMIZE)
    private boolean enableArrayMapLowCardinalityOptimize = true;

    @VariableMgr.VarAttr(name = ENABLE_MULTI_IN_LOW_CARDINALITY_OPTIMIZE)
    private boolean enableMultiInLowCardinalityOptimize = true;
    ...
    public boolean isEnableMultiArrayAggLowCardinalityOptimize() {
        return enableMultiArrayAggLowCardinalityOptimize;
    }
    ...
    public int getMultiArrayAggV2DebugLevel() {
        return this.multiArrayAggV2DebugLevel;
    }
    ...
    public boolean isEnableArrayMapLowCardinalityOptimize() {
        return enableArrayMapLowCardinalityOptimize;
    }

    public boolean isEnableMultiInLowCardinalityOptimize() {
        return enableMultiInLowCardinalityOptimize;
    }
