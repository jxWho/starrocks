...
class ExplainInputColumnsParserTest {
    ...
    void parseWithExtensions() {
        ...
        ExplainInputColumnsStmt.VirtualExtension firstExtension = statement.getVirtualExtensions().get(0);
        ...
        ExplainInputColumnsStmt.VirtualExtension secondExtension = statement.getVirtualExtensions().get(1);
