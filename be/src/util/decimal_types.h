...
static const uint128_t UINT128_T_MAX = uint128_t(int128_t(-1L));
static const int128_t INT128_T_MAX = UINT128_T_MAX >> 1;
static const int128_t INT128_T_MIN = -INT128_T_MAX - 1;
