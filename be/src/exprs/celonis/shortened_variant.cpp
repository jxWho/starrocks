...
ColumnPtr celonis_shortened_variant_impl(const Column& elements, const UInt32Column& offsets,
    ...
    using ValueType = RunTimeCppType<ActivityLT>;
...
template <LogicalType ActivityLT>
StatusOr<ColumnPtr> CelonisShortenedVariant<ActivityLT>::celonis_shortened_variant(FunctionContext* context,
    ...
    ColumnPtr result = celonis_shortened_variant_impl<ActivityLT>(*array_data.elements, *array_data.offsets,
...
template class CelonisShortenedVariant<TYPE_VARCHAR>;
template class CelonisShortenedVariant<TYPE_INT>;
