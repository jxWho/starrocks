...
/**
 * @param: [string_col, hash_col, width, sample_ratio]
 * @paramType: [VARCHAR, LARGEINT, CONST BIGINT, CONST DOUBLE]
 * @return: ARRAY_VARCHAR
 * This is the string version of CELONIS_CALC_BUCKET_WIDTH_BOUNDARIES.
 *
 */
...
public:
    ...
    void convert_to_serialize_format(FunctionContext* ctx, const Columns& src, size_t chunk_size,
        ...
        throw std::runtime_error(
                "celonis_calc_string_bucket_width_boundaries: convert_to_serialize_format not supported");
    }
