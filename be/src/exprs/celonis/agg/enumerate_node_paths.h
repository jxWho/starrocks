...
struct CelonisEnumerateNodePathsAggregateState;
...
public:
    ...
    void Enumerate(FunctionContext* ctx, const CelonisEnumerateNodePathsAggregateState& state, Column* to);
...
struct CelonisEnumerateNodePathsAggregateState {
    ...
    ~CelonisEnumerateNodePathsAggregateState() {
 ...
 */
class CelonisEnumerateNodePathsAggregateFunction
        : public AggregateFunctionBatchHelper<CelonisEnumerateNodePathsAggregateState,
                                              CelonisEnumerateNodePathsAggregateFunction> {
public:
    ...
    void convert_to_serialize_format(FunctionContext* ctx, const Columns& src, size_t chunk_size,
        ...
        throw std::runtime_error("celonis_enumerate_node_paths: convert_to_serialize_format is not supported. "
                                 "Not to trigger this, SET streaming_preaggregation_mode=\"force_preaggregation\"");
    }

    void finalize_to_column(FunctionContext* ctx, ConstAggDataPtr __restrict state, Column* to) const override;

    std::string get_name() const override { return "celonis_enumerate_node_paths"; }

private:
    void create_impl(FunctionContext* ctx, CelonisEnumerateNodePathsAggregateState& state,
