...
struct deviation_categories {
  deviation_categories_for_cases_t deviation_categories_v1;
  deviation_categories_for_cases_t deviation_categories_v2;
};
 ...
 * alignment.
 */
template <compute_incomplete_category ALSO_COMPUTE_V2>
