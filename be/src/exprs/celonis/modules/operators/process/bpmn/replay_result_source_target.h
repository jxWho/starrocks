...
class replay_result_source_target {
 public:
  ...
  replay_result_source_target(std::vector<vertex_id_type> source_ids, std::vector<vertex_id_type> target_ids,
  ...
  [[nodiscard]] const std::vector<vertex_id_type>& source_vertex_ids() const noexcept { return source_vertex_ids_; }
  [[nodiscard]] const std::vector<vertex_id_type>& target_vertex_ids() const noexcept { return target_vertex_ids_; }
 ...
 private:
  ...
  std::vector<vertex_id_type> source_vertex_ids_{};
  std::vector<vertex_id_type> target_vertex_ids_{};
