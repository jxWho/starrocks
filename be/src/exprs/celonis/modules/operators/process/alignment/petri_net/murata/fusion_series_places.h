...
class fusion_of_series_places {
 public:
   ...
   */
  static std::optional<fusion_of_series_places> try_build(const petri_net_builder& pn,
   ...
   * The input place is removed
   */
  void apply(petri_net::petri_net_builder& pn) const;

 private:
  fusion_of_series_places(node_id_type in_place, node_id_type transition, node_id_type out_place)
