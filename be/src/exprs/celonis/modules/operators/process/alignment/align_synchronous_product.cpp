...
std::optional<trace_alignment> search_synchronous_product_for_optimal_alignment(
  ...
  auto result{petri_net::a_star::a_star_search(synchronous_petri_net,
                                               petri_net::a_star::synchronous_product_heuristic{variant, accessor},
                                               petri_net::a_star::synchronous_product_path_construction{context},
