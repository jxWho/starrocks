...
struct solver_config {
  ...
  /// Limit BFS runs to avoid it running infinitely
  uint64_t bfs_max_depth{0};
};
...
template <>
struct std::hash<celonis::accelerator::operators::process::alignment::constraints_config> final {
  size_t operator()(const celonis::accelerator::operators::process::alignment::constraints_config& c) const noexcept {
