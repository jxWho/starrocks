...
namespace std {
template <>
struct variant_size<celonis::accelerator::format::json::json_value>
    : variant_size<celonis::accelerator::format::json::json_value::variant> {};

template <std::size_t I>
struct variant_alternative<I, celonis::accelerator::format::json::json_value>
    : variant_alternative<I, celonis::accelerator::format::json::json_value::variant> {};
}  // namespace std
...
struct _Extra_visit_slot_needed<_Maybe_variant_cookie, const celonis::accelerator::format::json::json_value&> {
...
namespace celonis::accelerator::format::json {
/**
 * nlohmann JSON conversion for custom type.
