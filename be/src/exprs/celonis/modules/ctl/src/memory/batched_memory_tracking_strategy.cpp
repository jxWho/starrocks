...
namespace celonis::accelerator::ctl::memory {
...
batched_memory_tracking_strategy::batched_memory_tracking_strategy(abstract_strategy_t downstream_strategy,
  ...
  ctl::global_memory_consumption_tracker::get_consumption_tracker().register_batched_tracker();
}
...
batched_memory_tracking_strategy::~batched_memory_tracking_strategy() {
  ...
  ctl::global_memory_consumption_tracker::get_consumption_tracker().deregister_batched_tracker();
}
