...
bitset_crtp_base<PARALLELISM_SETTING, DERIVED>::find_from(
  ...
  debug_assert(upper_bound_block_index <= num_blocks());
  auto view{static_cast<const DERIVED*>(this)->to_block_span()};
...
bitset_crtp_base<PARALLELISM_SETTING, DERIVED>::get_block_value_at_index(
  ...
  debug_assert(block_index < num_blocks());
  auto view{static_cast<const DERIVED*>(this)->to_block_span()};
...
template typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::value_type
bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::get_block_value_at_index(
    const block_index_type block_index) const noexcept;

template bool bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::all()
    const noexcept;

template bool bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::any()
    const noexcept;

template bool bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::none()
    const noexcept;

template
    typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::block_index_type
    bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::num_blocks()
        const noexcept;

template bool bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::empty()
    const noexcept;

template typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::size_type
bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::count(
    const bit_index_type idx_from, bit_index_type idx_to) const noexcept;

template
    typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::bit_index_type
    bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::find_first(
        const bit_index_type idx_from, bit_index_type idx_to) const noexcept;

template
    typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::bit_index_type
    bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::find_next(
        const bit_index_type idx_from, const bit_index_type idx_to) const noexcept;

template
    typename bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::bit_index_type
    bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_view_t>::find_from(
        block_index_type block_index, const block_index_type upper_bound_block_index) const noexcept;

template class bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::dynamic_bitset_t>;
template class bitset_crtp_base<details::bitset_types::parallelism_setting{true}, ctl::dynamic_bitset_parallel_t>;
template class bitset_crtp_base<details::bitset_types::parallelism_setting{false}, ctl::bitset_mutable_view_t>;
