 ...
 */
[[nodiscard]] format::json::json_object_t meminfo_change_json(const full_meminfo& old_meminfo,
...
constexpr meminfo::size_type meminfo::in_use_global() const noexcept {
  debug_assert(total_in_bytes_ >= available_in_bytes_);
