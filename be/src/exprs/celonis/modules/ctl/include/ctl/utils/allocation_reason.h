...
namespace celonis::accelerator::ctl::utils {
...
class allocation_reason {
 public:
  constexpr allocation_reason(ctl::source_location source_location, const std::string_view allocation_message) noexcept
      : source_location_{source_location}, allocation_message_{allocation_message} {}

  [[nodiscard]] constexpr const ctl::source_location& source_location() const& noexcept { return source_location_; }
...
class allocation_reason_enriched final : public allocation_reason {
 public:
  ...
  constexpr allocation_reason_enriched(ctl::source_location source_location, std::string_view allocation_message,
                                       ARGS&&... messages)
...
#define ALLOC_MSG(...) \
  (celonis::accelerator::ctl::utils::make_allocation_reason(celonis::accelerator::ctl::source_location{}, __VA_ARGS__))
