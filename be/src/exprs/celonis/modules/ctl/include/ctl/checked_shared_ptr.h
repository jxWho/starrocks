...
template <typename T>
struct hash<celonis::accelerator::ctl::checked_shared_ptr<T>> {
  [[nodiscard]] constexpr size_t operator()(const celonis::accelerator::ctl::checked_shared_ptr<T>& p) const {
