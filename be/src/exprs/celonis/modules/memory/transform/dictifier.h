...
[[nodiscard]] raw_dictionary_and_pointers dictify_impl(std::span<const T> data,
                                                       const memory::null_flags_bitset_t& null_flags,
                                                       uint64_t estimated_unique_value_count,
                                                       const std::string& description,
...
[[nodiscard]] raw_dictionary_and_pointers dictify_sort(std::span<const T> data,
                                                       const memory::null_flags_bitset_t& null_flags, row_id block_size,
                                                       const common::execution_context& context);
...
[[nodiscard]] raw_dictionary_and_pointers dictify_hash(std::span<const T> data, size_t estimated_unique_value_count,
                                                       const memory::null_flags_bitset_t& null_flags, size_t block_size,
                                                       const common::execution_context& context);
