...
template <typename T>
[[nodiscard]] raw_dictionary_and_pointers dictify(std::span<const T> data,
                                                  legacy_embedded_ctl::bitset_view_t null_flags,
...
template <typename T>
[[nodiscard]] size_t legacy_estimate_unique_value_count(std::span<const T> data,
                                                        legacy_embedded_ctl::bitset_view_t null_flags,
...
template <typename T>
[[nodiscard]] raw_dictionary_and_pointers dictify_impl(std::span<const T> data,
                                                       legacy_embedded_ctl::bitset_view_t null_flags,
...
template <typename T>
[[nodiscard]] raw_dictionary_and_pointers dictify_sort(std::span<const T> data,
                                                       legacy_embedded_ctl::bitset_view_t null_flags, row_id block_size,
                                                       const common::execution_context& context);
