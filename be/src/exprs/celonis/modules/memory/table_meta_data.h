...
class table_meta_data final {
 ...
 private:
  using user_visible_t = legacy_embedded_ctl::named_type<bool, struct user_visible_tag,
                                                         legacy_embedded_ctl::implicitly_convertible_to<bool>::templ>;
  using generated_t = legacy_embedded_ctl::named_type<bool, struct generated_tag,
                                                      legacy_embedded_ctl::implicitly_convertible_to<bool>::templ>;
  using system_table_t = legacy_embedded_ctl::named_type<bool, struct system_table_t,
                                                         legacy_embedded_ctl::implicitly_convertible_to<bool>::templ>;
...
constexpr table_meta_data table_meta_data::make_for_type() noexcept {
  if constexpr (TABLE_TYPE == table_meta_data::table_type::DATA_MODEL_TABLE) {
    ...
    static_assert(legacy_embedded_ctl::always_false_v<decltype(TABLE_TYPE)>,
                  "No factory function for SYSTEM_CATALOG_TABLE exists.");
