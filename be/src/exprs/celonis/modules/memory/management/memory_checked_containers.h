...
using checked_vector_t =
    std::vector<TYPE, std::scoped_allocator_adaptor<legacy_embedded_ctl::resource_owning_allocator<TYPE>>>;
...
[[nodiscard]] auto checked_allocator(
...
template <typename CONTAINER_TYPE,
          typename std::enable_if_t<legacy_embedded_ctl::is_base_of_template_v<ska::bytell_hash_map, CONTAINER_TYPE>>* =
              nullptr>
[[nodiscard]] auto checked_allocator(
    const common::execution_context& context, const legacy_embedded_ctl::utils::allocation_reason& reason,
    legacy_embedded_ctl::utils::allocation_priority priority = legacy_embedded_ctl::utils::allocation_priority::LOW) {
...
template <typename CONTAINER_TYPE,
          typename std::enable_if_t<legacy_embedded_ctl::is_base_of_template_v<ska::bytell_hash_set, CONTAINER_TYPE>>* =
              nullptr>
[[nodiscard]] auto checked_allocator(
    const common::execution_context& context, const legacy_embedded_ctl::utils::allocation_reason& reason,
    legacy_embedded_ctl::utils::allocation_priority priority = legacy_embedded_ctl::utils::allocation_priority::LOW) {
 ...
 */
template <typename TYPE, typename HASH_FUNCTION = std::hash<TYPE>, typename EQUALS_FUNCTION = std::equal_to<TYPE>>
using checked_unordered_set =
    std::unordered_set<TYPE, HASH_FUNCTION, EQUALS_FUNCTION,
                       std::scoped_allocator_adaptor<legacy_embedded_ctl::resource_owning_allocator<TYPE>>>;
constexpr size_t THRESHOLD_BYTES_UNORDERED_SET_MEMORY_CHECK = 65536;

template <typename CONTAINER_TYPE,
          typename std::enable_if_t<legacy_embedded_ctl::is_base_of_template_v<std::unordered_set, CONTAINER_TYPE>>* =
              nullptr>
[[nodiscard]] auto checked_allocator(
    const common::execution_context& context, const legacy_embedded_ctl::utils::allocation_reason& reason,
    legacy_embedded_ctl::utils::allocation_priority priority = legacy_embedded_ctl::utils::allocation_priority::LOW) {
...
using checked_unordered_map = std::unordered_map<
    KEY, T, HASH_FUNCTION, EQUALS_FUNCTION,
...
template <typename CONTAINER_TYPE,
          typename std::enable_if_t<legacy_embedded_ctl::is_base_of_template_v<std::unordered_map, CONTAINER_TYPE>>* =
              nullptr>
[[nodiscard]] auto checked_allocator(
    const common::execution_context& context, const legacy_embedded_ctl::utils::allocation_reason& reason,
    legacy_embedded_ctl::utils::allocation_priority priority = legacy_embedded_ctl::utils::allocation_priority::LOW) {
...
using checked_multi_index_t =
    ...
    boost::multi_index::multi_index_container<
        TYPE, INDEX, std::scoped_allocator_adaptor<legacy_embedded_ctl::resource_owning_allocator<TYPE>>>;
constexpr size_t THRESHOLD_BYTES_MULTI_INDEX_MEMORY_CHECK = 65536;
template <typename CONTAINER_TYPE, typename std::enable_if_t<legacy_embedded_ctl::is_base_of_template_v<
                                       boost::multi_index_container, CONTAINER_TYPE>>* = nullptr>
