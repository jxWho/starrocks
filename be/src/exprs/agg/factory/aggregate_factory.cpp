...
// Celonis functions
AggregateFunctionPtr AggregateFactory::MakeCelonisCalcStringBucketCountBoundariesAggregateFunction() {
...
AggregateFunctionPtr AggregateFactory::MakeCelonisMakeWeekdayCalendarAggregateFunction() {
    return std::make_shared<WeekdayCalendarAggregateFunction>();
}
...
AggregateFunctionPtr AggregateFactory::MakeCelonisArrayLagWindowFunction() {
    return std::make_shared<CelonisArrayLeadLagAggregateFunction>();
}
...
AggregateFunctionPtr AggregateFactory::MakeCelonisGraphAggregateFunction() {
