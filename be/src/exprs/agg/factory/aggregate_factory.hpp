...
public:
    ...
    static AggregateFunctionPtr MakeMultiArrayAggV3AggregateFunction() {
        return std::make_shared<MultiArrayAggV3AggregateFunction>();
    }
    ...
    // Celonis functions
    template <LogicalType>
    static AggregateFunctionPtr MakeCelonisLinearInterpolateFunction();
    ...
    static AggregateFunctionPtr MakeCelonisMakeWeekdayCalendarAggregateFunction();
...
template <LogicalType LT>
AggregateFunctionPtr AggregateFactory::MakeCelonisLinearInterpolateFunction() {
    return std::make_shared<CelonisLinearInterpolateWindowFunction<LT>>();
}
...
template <LogicalType LT>
AggregateFunctionPtr AggregateFactory::MakeCelonisCalcBucketBoundariesAggregateFunction() {
    return std::make_shared<CelonisCalcBucketBoundariesAggregateFunction<LT>>();
}
