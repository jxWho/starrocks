...
TEST_F(CelonisMathFunctionsTest, empty_input) {
...
TEST_F(CelonisMathFunctionsTest, int_input) {
    auto values = ColumnHelper::create_column(TypeDescriptor(TYPE_INT), true);
...
TEST_F(CelonisMathFunctionsTest, bigint_input) {
...
TEST_F(CelonisMathFunctionsTest, double_input) {
