...
TEST_F(CelonisArrayEndFinderTest, celonis_array_int) {
...
TEST_F(CelonisArrayEndFinderTest, celonis_array_bigint) {
...
TEST_F(CelonisArrayEndFinderTest, celonis_array_double) {
...
TEST_F(CelonisArrayEndFinderTest, celonis_array_varchar) {
...
TEST_F(CelonisArrayEndFinderTest, celonis_array_datetime) {
