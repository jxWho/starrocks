...
TEST_F(CelonisArrayFunctionsTest, dedup_sorted_by_datetime) {
    ...
    input_array->append_datum(
            DatumArray{TimestampValue::create(2017, 10, 1, 1, 32, 32), TimestampValue::create(2017, 10, 2, 1, 32, 32),
                       TimestampValue::create(2017, 10, 3, 1, 32, 32), TimestampValue::create(2017, 10, 3, 2, 32, 32),
...
TEST_F(CelonisArrayFunctionsTest, activities_to_variant_only_null) {
    auto activities_array = ColumnHelper::create_const_null_column(2);
...
TEST_F(CelonisArrayFunctionsTest, activities_to_variant_normal_cases) {
    auto activities_array = ColumnHelper::create_column(TYPE_ARRAY_VARCHAR, true);
    activities_array->append_datum(DatumArray{"a1", "a2", kNullDatum});
    activities_array->append_datum(kNullDatum);
    activities_array->append_datum(DatumArray{"a1", kNullDatum, "abc", kNullDatum, kNullDatum, "a3", ""});
    activities_array->append_datum(DatumArray{});
    activities_array->append_datum(DatumArray{""});
    activities_array->append_datum(DatumArray{kNullDatum});
    activities_array->append_datum(DatumArray{kNullDatum, kNullDatum});
    activities_array->append_datum(DatumArray{kNullDatum, "", "abc", kNullDatum, "", "abc", ""});
    activities_array->append_datum(DatumArray{"activity"});
    const auto result = CelonisArrayFunctions::activities_to_variant(nullptr, {activities_array}).value();
...
TEST_F(CelonisArrayFunctionsTest, activities_to_variant_empty_array) {
    auto activities_array = ColumnHelper::create_column(TYPE_ARRAY_VARCHAR, true);
    activities_array->append_datum(DatumArray{});
    activities_array->append_datum(DatumArray{});
    const auto result = CelonisArrayFunctions::activities_to_variant(nullptr, {activities_array}).value();
...
TEST_F(CelonisArrayFunctionsTest, array_lag_datetime) {
    auto input_array = ColumnHelper::create_column(TYPE_ARRAY_DATETIME, false);
    input_array->append_datum(
            DatumArray{TimestampValue::create(2020, 8, 10, 1, 32, 32), TimestampValue::create(2020, 8, 10, 2, 32, 32),
                       TimestampValue::create(2020, 8, 10, 3, 32, 32), TimestampValue::create(2020, 8, 10, 4, 32, 32),
...
TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_one_way) {
    ...
    auto size_array = ColumnHelper::create_column(TypeDescriptor::create_array_type(TypeDescriptor(TYPE_INT)), false);
    size_array->append_datum(DatumArray{7});
    size_array->append_datum(DatumArray{4});

    auto priority_array =
            ColumnHelper::create_column(TypeDescriptor::create_array_type(TypeDescriptor(TYPE_INT)), false);
    priority_array->append_datum(DatumArray{1});
    priority_array->append_datum(DatumArray{1});
    ...
    EXPECT_EQ(120, result->get(0).get_array()[1].get_int32());
    EXPECT_EQ(215, result->get(0).get_array()[2].get_int32());
    EXPECT_EQ(225, result->get(0).get_array()[3].get_int32());
    EXPECT_EQ(318, result->get(0).get_array()[4].get_int32());
    ...
    EXPECT_EQ(1010, result->get(1).get_array()[0].get_int32());
    EXPECT_EQ(1020, result->get(1).get_array()[1].get_int32());
    EXPECT_EQ(2000, result->get(1).get_array()[2].get_int32());
...
TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_order_determined_by_secondary_orders) {
    ...
    auto secondary_order_array =
            ColumnHelper::create_column(TypeDescriptor::create_array_type(TypeDescriptor(TYPE_BIGINT)), false);
    secondary_order_array->append_datum(DatumArray{1L, 2L, 7L, 8L, 4L, 5L, 6L});
    ...
    limit_column->append_datum(100L);
    ...
    EXPECT_EQ(110, result->get(0).get_array()[0].get_int32());
    EXPECT_EQ(120, result->get(0).get_array()[1].get_int32());
    EXPECT_EQ(310, result->get(0).get_array()[2].get_int32());
    EXPECT_EQ(315, result->get(0).get_array()[3].get_int32());
    EXPECT_EQ(320, result->get(0).get_array()[4].get_int32());
    EXPECT_EQ(215, result->get(0).get_array()[5].get_int32());
...
TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_priority_size_mismatch_with_timestamp) {
    ...
    EXPECT_EQ(rs.status().message(),
              "When limit is set and priority_array is not NULL literal, priority_array (length = 3) should have the "
              "same length as timestamp_array (length = 7).");
}
...
TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_null_timestamps) {
    auto input_array = ColumnHelper::create_column(TypeDescriptor::create_array_type(TypeDescriptor(TYPE_INT)), false);
    input_array->append_datum(DatumArray{100, 310, 315, 320});
    ...
    ASSERT_EQ(4, result->get(0).get_array().size());
    EXPECT_EQ(310, result->get(0).get_array()[0].get_int32());
    EXPECT_EQ(100, result->get(0).get_array()[1].get_int32());
    EXPECT_EQ(315, result->get(0).get_array()[2].get_int32());
    EXPECT_EQ(320, result->get(0).get_array()[3].get_int32());
}

TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_null_sortings) {
    auto input_array = ColumnHelper::create_column(TypeDescriptor::create_array_type(TypeDescriptor(TYPE_INT)), false);
    input_array->append_datum(DatumArray{110, 120, 310, 315, 320});
    input_array->append_datum(DatumArray{1010, 1020, 2010, 2020});
    ...
    secondary_order_array->append_datum(DatumArray{-10000L, 2L, Datum{}, 4L});
    secondary_order_array->append_datum(DatumArray{1L, 2L, 3L, 4L, 5L});
    ...
    EXPECT_EQ(110, result->get(0).get_array()[0].get_int32());
    EXPECT_EQ(310, result->get(0).get_array()[1].get_int32());
    EXPECT_EQ(120, result->get(0).get_array()[2].get_int32());
    EXPECT_EQ(315, result->get(0).get_array()[3].get_int32());
    EXPECT_EQ(320, result->get(0).get_array()[4].get_int32());
    ASSERT_EQ(4, result->get(1).get_array().size());
    EXPECT_EQ(2010, result->get(1).get_array()[0].get_int32());
    EXPECT_EQ(1010, result->get(1).get_array()[1].get_int32());
    EXPECT_EQ(1020, result->get(1).get_array()[2].get_int32());
    EXPECT_EQ(2020, result->get(1).get_array()[3].get_int32());
...
TEST_F(CelonisArrayFunctionsTest, merge_sorted_arrays_null_secondary_order_with_secondary_nulls_first) {
    ...
    const auto rs1 = CelonisArrayFunctions::merge_sorted_arrays(
            nullptr, {input_array, timestamp_array, size_array, priority_array, secondary_order_array,
    ...
    const auto rs2 = CelonisArrayFunctions::merge_sorted_arrays(
            nullptr, {input_array, timestamp_array, size_array, priority_array, secondary_order_array,
...
TEST_F(CelonisArrayFunctionsTest, calc_crop_normal_cases) {
    // empty input
    {
        ...
        const auto result = CelonisArrayFunctions::calc_crop<TYPE_VARCHAR>(
...
TEST_F(CelonisArrayFunctionsTest, calc_crop_normal_cases_int) {
    // empty input
    {
        ...
        const auto result = CelonisArrayFunctions::calc_crop<TYPE_INT>(
                                    nullptr, {activity, begin_activity, begin_mode, end_activity, end_mode})
                                    .value();
        EXPECT_EQ(0, result->size());
    }
    ...
    }
    {
        ...
        activity->append_datum(DatumArray{kNullDatum, 2, kNullDatum, 3, 3, kNullDatum, 6, 3, 4, kNullDatum});
        begin_activity->append_datum(2);
        begin_mode->append_datum("FIRST");
        end_activity->append_datum(3);
        end_mode->append_datum("LAST");
    ...
    }
    {
        ...
        activity->append_datum(DatumArray{kNullDatum, 2, kNullDatum, 2, kNullDatum});
        begin_activity->append_datum(kNullDatum);
        begin_mode->append_datum("ALL");
        end_activity->append_datum(kNullDatum);
        end_mode->append_datum("ALL");
...
TEST_F(CelonisArrayFunctionsTest, calc_crop_null_input_int) {
    {
...
TEST_F(CelonisArrayFunctionsTest, calc_crop_invalid_input_int) {
    {
        auto activity = ColumnHelper::create_column(TYPE_ARRAY_INT, false);
        auto begin_activity = ColumnHelper::create_column(TypeDescriptor(TYPE_INT), false);
        auto begin_mode = ColumnHelper::create_column(TypeDescriptor(TYPE_VARCHAR), false);
...
TEST_F(CelonisArrayFunctionsTest, array_count_normal_case) {
    ...
    // DATETIME
    {
        ...
        arrays->append_datum(DatumArray{TimestampValue::create(1973, 1, 1, 0, 0, 0),
                                        TimestampValue::create(1975, 1, 1, 0, 0, 0),
