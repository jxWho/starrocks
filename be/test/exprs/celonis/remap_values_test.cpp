...
class CelonisRemapValuesTest : public ::testing::Test {
protected:
    void SetUp() override {}
...
private:
    ...
    StatusOr<ColumnPtr> Run(bool has_default) {
        ...
        if (has_default) {
            result = CelonisRemapValues<LT>::remap_values(
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_const_inconsist_value_map) {
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_null_in_value_map_with_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_null_in_value_map_without_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_string_with_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_string_empty_value_map_with_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_string_map_overwrite_with_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_string_without_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_string_empty_value_map_without_default) {
    const LogicalType LT = TYPE_VARCHAR;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_non_constant_string) {
    {
        const LogicalType LT = TYPE_VARCHAR;
        Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_bigint) {
    const LogicalType LT = TYPE_BIGINT;
    Prepare<LT>();
...
TEST_F(CelonisRemapValuesTest, celonis_remap_values_const_value_column) {
    {
