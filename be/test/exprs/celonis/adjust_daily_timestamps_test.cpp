...
protected:
    ...
    void run_scenario(const EventlogScenario& scenario, const ExpectedResult& expected_result,
        ...
        Columns columns{scenario.timestamp_column, scenario.is_day_based_column};
