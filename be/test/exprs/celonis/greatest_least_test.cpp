...
TEST_F(CelonisGreatestLeastTest, celonis_greatest_int_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({3L, 2L, 2L, 3L, kNullDatum, 1L})};
...
TEST_F(CelonisGreatestLeastTest, celonis_greatest_double_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({3., 2., 2., 3., kNullDatum, 1.})};
...
TEST_F(CelonisGreatestLeastTest, celonis_greatest_datetime_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({3_ts, 2_ts, 2_ts, 3_ts, kNullDatum, 1_ts})};
...
TEST_F(CelonisGreatestLeastTest, celonis_least_int_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({1L, 1L, 1L, 2L, kNullDatum, 1L})};
...
TEST_F(CelonisGreatestLeastTest, celonis_least_double_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({1., 1., 1., 2., kNullDatum, 1.})};
...
TEST_F(CelonisGreatestLeastTest, celonis_least_datetime_data_mixed_nulls) {
    ...
    const auto [expected_size, expected_nulls, expected_values]{make_expected<T>({1_ts, 1_ts, 1_ts, 2_ts, kNullDatum, 1_ts})};
