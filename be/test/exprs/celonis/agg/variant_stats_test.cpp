...
TEST_F(CelonisVariantStatsTest, test_merge_distinct_dict) {
    ...
    Slice slice = result->get_slice(0);
    std::string rs = slice.to_string();
    std::string e_s = "{'dict':[{'id':3,'name':'a4'},{'id':2,'name':'a3'},{'id':4,'name':'a0'},{'id':0,'name':'a1'},{'id':5,'name':'a5'},{'id':1,'name':'a2'}],'a_stats':[{'count':4,'count_case':4,'count_start':4,'count_end':0,'id':0},{'count':5,'count_case':3,'count_start':0,'count_end':1,'self_loop_count_case':1,'id':1},{'count':2,'count_case':2,'count_start':1,'count_end':1,'id':2},{'count':2,'count_case':2,'count_start':0,'count_end':1,'id':3},{'count':1,'count_case':1,'count_start':0,'count_end':1,'id':4},{'count':1,'count_case':1,'count_start':0,'count_end':1,'id':5}],'e_stats':[{'count':1,'count_case':1,'src':0,'dst':3},{'count':2,'count_case':1,'src':1,'dst':1},{'count':1,'count_case':1,'src':1,'dst':5},{'count':1,'count_case':1,'src':2,'dst':3},{'count':1,'count_case':1,'src':3,'dst':4},{'count':3,'count_case':3,'src':0,'dst':1},{'count':1,'count_case':1,'src':1,'dst':2}],'top':[{'id':0,'top':[{'variant':[0,1],'count':1},{'variant':[0,1,1,1,5],'count':1},{'variant':[0,1,2],'count':1},{'variant':[0,3,4],'count':1}]},{'id':1,'top':[{'variant':[0,1],'count':1},{'variant':[0,1,1,1,5],'count':1},{'variant':[0,1,2],'count':1}]},{'id':2,'top':[{'variant':[0,1,2],'count':1},{'variant':[2,3],'count':1}]},{'id':3,'top':[{'variant':[0,3,4],'count':1},{'variant':[2,3],'count':1}]},{'id':4,'top':[{'variant':[0,3,4],'count':1}]},{'id':5,'top':[{'variant':[0,1,1,1,5],'count':1}]}],'happy':{'variant':[0,1],'count':1},'e_count':7}";
    match(e_s, rs);
}
