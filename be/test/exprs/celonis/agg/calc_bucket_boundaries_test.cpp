...
protected:
    ...
    template<LogicalType LT>
    void RunMergeToNew(const DatumArray& input1, const DatumArray& input2, int count, const Datum& expected) {
        auto [local_ctx1, state1, func] = RunUpdate(LT, input1, count);
        auto [local_ctx2, state2, func2] = RunUpdate(LT, input2, count);
    ...
    template<LogicalType LT>
    void Run(const DatumArray& input1, const DatumArray& input2, int count, const Datum& expected) {
