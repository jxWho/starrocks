...
class CelonisCalcStringBucketWidthBoundariesTest : public testing::Test {
protected:
    CelonisCalcStringBucketWidthBoundariesTest() = default;
    ...
    RunUpdate(const std::vector<std::optional<std::string>>& strings,
        ...
        auto width_col = ColumnHelper::create_const_column<TYPE_BIGINT>(width, strings.size());
        ...
        raw_columns[2] = width_col.get();
        raw_columns[3] = sample_ratio_col.get();
        local_ctx->set_constant_columns({nullptr, nullptr, width_col, sample_ratio_col});
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, even_number_of_strings_1) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, even_number_of_strings_2) {
    std::vector<std::optional<std::string>> strings1 = {"a", "b", "c", "d", "e"};
    std::vector<std::optional<std::string>> strings2 = {"f", "g", "h", "i", "j"};
    std::vector<std::optional<int128_t>> hashes1 = {1, 2, 3, 4, 5};
    std::vector<std::optional<int128_t>> hashes2 = {6, 7, 8, 9, 10};
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, empty_string_works) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, odd_number_of_strings_1) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, odd_number_of_strings_2) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, non_positive_width) {
    std::vector<std::optional<std::string>> strings1 = {"a", "b", "c", "d", "e"};
    std::vector<std::optional<std::string>> strings2 = {"f", "g", "h", "i", "j"};
    std::vector<std::optional<int128_t>> hashes1 = {1, 2, 3, 4, 5};
    std::vector<std::optional<int128_t>> hashes2 = {6, 7, 8, 9, 10};
    // If width is not positive, the implementation will use the default value (width = 1).
    int64_t width = -1;
    double sample_ratio = 1.0;
    auto expected = DatumArray{"a", "b", "c", "d", "e", "f", "g", "h", "i", "j"};
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, sample_ratio_greater_than_one) {
    std::vector<std::optional<std::string>> strings1 = {"a", "b", "c", "d", "e"};
    std::vector<std::optional<std::string>> strings2 = {"f", "g", "h", "i", "j"};
    std::vector<std::optional<int128_t>> hashes1 = {1, 2, 3, 4, 5};
    std::vector<std::optional<int128_t>> hashes2 = {6, 7, 8, 9, 10};
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, duplicate_strings) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, null_strings_are_ignored) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, null_hashes_are_ignored) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, DISABLED_too_many_buckets) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, sampling_works_1) {
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, min_and_max_are_tracked) {
    int128_t hash_to_drop = std::numeric_limits<int128_t>::max() / 10 * 3;
    std::vector<std::optional<std::string>> strings1 = {"a", "b", "c"};
    std::vector<std::optional<std::string>> strings2 = {"d", "e", "f"};
...
TEST_F(CelonisCalcStringBucketWidthBoundariesTest, sampling_works_2) {
