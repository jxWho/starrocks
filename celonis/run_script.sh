...
# This file is based on the instructions here
# https://docs.starrocks.com/en-us/latest/quick_start/Deploy#create-script with
# minor changes to update the starocks path to be version-agnostic.
